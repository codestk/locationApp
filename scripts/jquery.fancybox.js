				...
				if ($.type(element) === "object") {
					...
					if (isQuery(element)) {
						obj = {
						    ...
						    //momojojo-fix dipaly systax html in title Bab Way
						    //Refer Event.js Pure_Keyword
						    title: element.data('fancybox-title') || Texthighlight(element.attr('rel'), Pure_Keyword, 'highlight'),
